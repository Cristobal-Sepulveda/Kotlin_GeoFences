...
import com.example.android.treasureHunt.Constants.BACKGROUND_LOCATION_PERMISSION_INDEX
import com.example.android.treasureHunt.Constants.LOCATION_PERMISSION_INDEX
import com.example.android.treasureHunt.Constants.REQUEST_FOREGROUND_AND_BACKGROUND_PERMISSION_RESULT_CODE
import com.example.android.treasureHunt.Constants.REQUEST_FOREGROUND_ONLY_PERMISSIONS_REQUEST_CODE
import com.example.android.treasureHunt.Constants.REQUEST_TURN_DEVICE_LOCATION_ON
...
class HuntMainActivity : AppCompatActivity() {
    ...
    //TODO 1.2: variable to check API
        ...
        locationSettingsResponseTask.addOnFailureListener { exception ->
            if (exception is ResolvableApiException && resolve){
                ...
                try {
                    ...
                    Log.d(Constants.TAG, "Error geting location settings resolution: " + sendEx.message)
                }
            } else {
                Snackbar.make(
 ...
 */
            ...
            addOnCompleteListener {
                ...
                geofencingClient.addGeofences(geofencingRequest, geofencePendingIntent)?.run {
                    ...
                    addOnFailureListener {
                        ...
                        if ((it.message != null)) {
                            Log.w(Constants.TAG, it.message!!)
                        }
                    }
                }
            }
    ...
    private fun removeGeofences() {
        ...
        geofencingClient.removeGeofences(geofencePendingIntent)?.run {
            addOnSuccessListener {
                // Geofences removed
                Log.d(Constants.TAG, getString(R.string.geofences_removed))
                Toast.makeText(applicationContext, R.string.geofences_removed, Toast.LENGTH_SHORT)
                    .show()
            }
            addOnFailureListener {
                // Failed to remove geofences
                Log.d(Constants.TAG, getString(R.string.geofences_not_removed))
            }
        }
    }
